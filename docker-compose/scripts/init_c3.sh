...
# Init vault_c3_s1
tput setaf 11 && echo "*** Init vault_c3_s1"
...
# Unseal vault_c3_s1
tput setaf 11 && echo "*** Unseal vault_c3_s1"
export VAULT_ADDR=https://localhost:38201
...
# Join vault_c3_s2
tput setaf 11 && echo "*** Join vault_c3_s2"
...
# Unseal vault_c3_s2
tput setaf 11 && echo "*** Unseal vault_c3_s2"
vault operator unseal ${unseal_key}

# Join vault_c3_s3
tput setaf 11 && echo "*** Join vault_c3_s3"
...
# Unseal vault_c3_s3
tput setaf 11 && echo "*** Unseal vault_c3_s3"
vault operator unseal ${unseal_key}
...
tput setaf 11 && echo "*** Vault_C3 Cluster members"
