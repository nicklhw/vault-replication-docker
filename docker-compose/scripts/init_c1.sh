...
# Init vault_c1_s1
tput setaf 11 && echo "*** Init vault_c1_s1"
...
# Unseal vault_c1_s1
tput setaf 11 && echo "*** Unseal vault_c1_s1"
export VAULT_ADDR=https://localhost:18201
...
# Join vault_c1_s2
tput setaf 11 && echo "*** Join vault_c1_s2"
...
# Unseal vault_c1_s2
tput setaf 11 && echo "*** Unseal vault_c1_s2"
vault operator unseal ${unseal_key}

# Join vault_c1_s3
tput setaf 11 && echo "*** Join vault_c1_s3"
...
# Unseal vault_c1_s3
tput setaf 11 && echo "*** Unseal vault_c1_s3"
vault operator unseal ${unseal_key}
...
tput setaf 11 && echo "*** Vault_C1 Cluster members "
vault operator members

export VAULT_TOKEN=$(cat ${VAULT_INIT_OUTPUT} | jq -r '.root_token')
#vault token lookup

tput setaf 11 && echo "*** Configure admin policy on Vault_C1 "

vault policy write admin ./admin_policy.hcl

tput setaf 11 && echo "*** Enable userpass auth on Vault_C1 "
